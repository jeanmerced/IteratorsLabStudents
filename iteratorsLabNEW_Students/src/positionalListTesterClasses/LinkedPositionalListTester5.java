...
import llPositionalList.LinkedPositionalListMaker;
import llPositionalList.PLIteratorF2L;

public class LinkedPositionalListTester5 {

	public static void main(String[] args) {
		LinkedPositionalListMaker<Integer> list1 =  
				new LinkedPositionalListMaker<>(new L2FIteratorMaker<Integer>()); 
	...
	private static void removeEvenValues(LinkedPositionalListMaker<Integer> list) {
	...
	private static void showList(String msg, LinkedPositionalListMaker<Integer> list) {
