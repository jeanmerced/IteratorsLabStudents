...
public class LinkedPositionalListMaker<E> implements PositionalList<E> {
		...
		public LinkedPositionalListMaker() {
			header = new DNode<>(); 
			trailer = new DNode<>(); 
		...
		public LinkedPositionalListMaker(PLIteratorMaker<E> maker) {
			this();
			iteratorMaker = maker;
		}
		...
		private class PositionIterator implements Iterator<Position<E>> {
			Iterator<Position<E>> posIterator = iteratorMaker.makeIterator(LinkedPositionalListMaker.this);
		...
		private class PositionIterable implements Iterable<Position<E>> {
			...
			public Iterator<Position<E>> iterator() {
				return iteratorMaker.makeIterator(LinkedPositionalListMaker.this);
			} 
